 ...
 * processors: PrepRequestProcessor -> PeerProposalRequestProcessor ->
 * CommitProcessor -> Peer.ToBeAppliedRequestProcessor ->
 * FinalRequestProcessor
 */
public class PeerZooKeeperServer extends QuorumZooKeeperServer {
     ...
     * @throws IOException
     */
    PeerZooKeeperServer(FileTxnSnapLog logFactory, QuorumPeer self,
    ...
    protected void setupRequestProcessors() {
        ...
        RequestProcessor toBeAppliedProcessor = new Peer.ToBeAppliedRequestProcessor(
                finalProcessor, getPeer().toBeApplied);
        commitProcessor = new CommitProcessor(toBeAppliedProcessor,
                Long.toString(getServerId()), false);
        commitProcessor.start();
        PeerProposalRequestProcessor peerProposalProcessor = new PeerProposalRequestProcessor(this,
                commitProcessor);
        peerProposalProcessor.initialize();
        firstProcessor = new PrepRequestProcessor(this, peerProposalProcessor);
