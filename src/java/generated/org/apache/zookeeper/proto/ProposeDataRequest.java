...
public class ProposeDataRequest implements Record {
  private String path;
  private byte[] data;
  private int version;  
  private boolean watch;
  
  public ProposeDataRequest() {
  }
  public ProposeDataRequest(
        String path,
        byte[] data,
  ...
  public void ProposeData(byte[] m_) {
    data=m_;
  }
  ...
  public int compareTo (Object peer_) throws ClassCastException {
    if (!(peer_ instanceof ProposeDataRequest)) {
      throw new ClassCastException("Comparing different types of records.");
    }
    ProposeDataRequest peer = (ProposeDataRequest) peer_;
    int ret = 0;
  ...
  public static String signature() {
    return "LProposeDataRequest(sBi)";
  }
}
