...
public class ProposeDataResponse implements Record {
  private byte[] data;
  private org.apache.zookeeper.data.Stat stat;
  public ProposeDataResponse() {
  }
  public ProposeDataResponse(
        byte[] data,
  ...
  public int compareTo (Object peer_) throws ClassCastException {
    if (!(peer_ instanceof ProposeDataResponse)) {
      throw new ClassCastException("Comparing different types of records.");
    }
    ProposeDataResponse peer = (ProposeDataResponse) peer_;
    int ret = 0;
    {
      byte[] my = data;
      byte[] ur = peer.data;
  ...
  public static String signature() {
    return "LProposeDataResponse(BLStat(lllliiiliil))";
  }
}
